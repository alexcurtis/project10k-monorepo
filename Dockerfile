...
COPY --from=builder /usr/src/project10k/apps/project10k-client/public ./public

# Automatically leverage output traces to reduce image size
# https://nextjs.org/docs/advanced-features/output-file-tracing
COPY --from=builder --chown=nextjs:nodejs /usr/src/project10k/apps/project10k-client/.next/standalone ./
COPY --from=builder --chown=nextjs:nodejs /usr/src/project10k/apps/project10k-client/.next/static ./.next/static
